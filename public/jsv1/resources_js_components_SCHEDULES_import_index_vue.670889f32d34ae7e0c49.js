...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapActions)(["SETUP_UPLOAD_USERS"])), {}, {
    ...
    redirectingLink: function redirectingLink(e) {
      var route = this.$router.resolve({
        name: e
      });
      window.open(route.href);
    },
    realTime: function realTime(value) {
      if (value) {
                          ...
                          _c("v-card-text", [
                            _vm._v(
                              "\n                        You have " +
                                ...
                                " failed import due to below missing fields\n                    "
                            )
                          ]),
                          _vm._v(" "),
                          _c("v-simple-table", {
      ...
      _c(
        ...
        [
          _c(
            ...
            [
              _c("v-card-title", [
                _c("p", { staticClass: "text-h4" }, [_vm._v("How to use")])
              ]),
              _vm._v(" "),
              _c("v-card-text", [
                _c("ol", [
                  _c("li", [
                    _vm._v(
                      'Download the template by clicking "Download template here"'
                    )
                  ]),
                  _vm._v(" "),
                  _c("li", [_vm._v("Open the downloaded excel file")]),
                  _vm._v(" "),
                  _c("li", [
                    _vm._v(
                      "Click Data inside the ribbon under Queries & Connections; click Refresh All to download the data"
                    )
                  ]),
                  _vm._v(" "),
                  _c("li", [
                    _vm._v(
                      "After you fill up the schedule template; save it of course"
                    )
                  ]),
                  _vm._v(" "),
                  _c("li", [_vm._v("Go back to the import schedule link")]),
                  _vm._v(" "),
                  _c("li", [
                    _vm._v(
                      'Click "Choose File" and locate where did you save the schedule template (the one with the latest schedule, ok?). Double click the file or click the file then open (Do you follow?)'
                    )
                  ]),
                  _vm._v(" "),
                  _c("li", [
                    _vm._v(
                      "Click the upload button (Make sure that you put the correct file...). Think before you click"
                    )
                  ]),
                  _vm._v(" "),
                  _c("li", [
                    _vm._v(
                      "After you click the upload button, wait for the loading icon to be finish, and count one to one hundred, and you will just realize that I am gone."
                    )
                  ]),
                  _vm._v(" "),
                  _c("li", [
                    _vm._v(
                      "Reload the browser after your upload the file to clear the your dirty thoughts about me"
                    )
                  ]),
                  _vm._v(" "),
                  _c("li", [
                    _vm._v(
                      "That's it! well done, you have passed the uploading of schedule sessions."
                    )
                  ]),
                  _vm._v(" "),
                  _c("li", [
                    _vm._v(
                      "Paalam! Sayonara! Annyoeng! Goodbye! Yala bye! Adios Amigo!"
                    )
                  ])
                ]),
                _vm._v(" "),
                ...
                _c("p", [
                  _vm._v(
                    "note: if items are not inside the dropbox create new one inside the system and not in the excel shit"
                  )
                ]),
                _vm._v(" "),
                _c(
                  ...
                  [
                    ...
                    _c(
                      "v-btn",
                      {
                        ...
                        on: {
                          click: function($event) {
                            return _vm.redirectingLink("DateRangeAdd")
                          }
                        }
                      },
                      [_vm._v("Term")]
                    ...
                    _c(
                      "v-btn",
                      {
                        ...
                        on: {
                          click: function($event) {
                            return _vm.redirectingLink("LocationAdd")
                          }
                        }
                      },
                      [_vm._v("Location")]
                    ...
                    _c(
                      "v-btn",
                      {
                        ...
                        on: {
                          click: function($event) {
                            return _vm.redirectingLink("ProductAdd")
                          }
                        }
                      },
                      [_vm._v("Lesson")]
                    ...
                    _c(
                      "v-btn",
                      {
                        ...
                        on: {
                          click: function($event) {
                            return _vm.redirectingLink("TeacherAdd")
                          }
                        }
                      },
                      [_vm._v("Teacher")]
                    ...
                    _c(
                      "v-btn",
                      {
                        ...
                        on: {
                          click: function($event) {
                            return _vm.redirectingLink("StudioAdd")
                          }
                        }
                      },
                      [_vm._v("Studio")]
                ...
                _vm._v(" "),
                _c("p", [_vm._v("After you create, go back to step #3")])
              ])
            ],
            1
          )
