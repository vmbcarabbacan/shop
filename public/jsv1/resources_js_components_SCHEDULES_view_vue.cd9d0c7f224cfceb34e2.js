...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_0__.mapActions)(["SCHEDULES", "SCHEDULE_CHANGE_VISIBLE"])), (0,vuex__WEBPACK_IMPORTED_MODULE_0__.mapMutations)(["SCHEDULE_LOADING", "SCHEDULE_FILTER"])), {}, {
    ...
    goEdit: function goEdit(e) {
      var route = this.$router.resolve("/auth/schedules/edit/".concat(e.id));
      window.open(route.href);
    },
    changeVisible: function changeVisible(e) {
      this.SCHEDULE_CHANGE_VISIBLE({
        item: e
      });
    }
  }),
