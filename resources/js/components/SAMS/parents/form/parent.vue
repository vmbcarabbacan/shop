                ...
                <v-card-text>
                    ...
                    >
                        ...
                        >
                            <v-text-field 
                                label="Nationality" 
                                v-model="sams.form.mom.nationality"
                            >
                            </v-text-field>
                        </v-col>
                        <v-col
                        ...
                        >
                            <v-text-field 
                                label="Home Number" 
                                v-model="sams.form.mom.homeNumber"
                                type="number"
                                hint="example: 565123456"
                                persistent-hint
                            >
                        ...
                        >
                            <v-text-field 
                                label="Work Number" 
                                v-model.number="sams.form.mom.workNumber"
                                type="number"
                                hint="example: 565123456"
                                persistent-hint
                            >
                ...
                <v-card-text>
                    ...
                    >
                        ...
                        >
                            <v-text-field 
                                label="First Name" 
                                v-model="sams.form.dad.firstName"
                                :rules="specialRules"
                                suffix="*"
                            >
                            </v-text-field>
                        ...
                        >
                            <v-text-field 
                                label="Family Name" 
                                v-model="sams.form.dad.familyName"
                                :rules="specialRules"
                                suffix="*"
                            >
                            </v-text-field>
                        ...
                        >
                            <v-text-field 
                                label="Email Address" 
                                v-model="sams.form.dad.emailAddress"
                        ...
                        >
                            <v-text-field 
                                label="Nationality" 
                                v-model="sams.form.dad.nationality"
                            >
                            </v-text-field>
                        </v-col>
                        <v-col
                        ...
                        >
                            <v-text-field 
                                label="Mobile Number" 
                                v-model.number="sams.form.dad.mobileNumber"
                                type="number"
                                :rules="[v => !!v || 'Mobile number is required']"
                                suffix="*"
                                hint="example: 565123456"
                        ...
                        >
                            <v-text-field 
                                label="Home Number" 
                                v-model.number="sams.form.dad.homeNumber"
                                type="number"
                                hint="example: 565123456"
                                persistent-hint
                            >
                        ...
                        >
                            <v-text-field 
                                label="Work Number" 
                                v-model.number="sams.form.dad.workNumber"
                                type="number"
                                hint="example: 565123456"
                                persistent-hint
                            >
