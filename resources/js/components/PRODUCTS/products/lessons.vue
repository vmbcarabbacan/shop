    ...
    >
        <v-card>
            ...
            <v-card-actions>
                ...
                >
                    Selected Uniforms({{ product.product.relatedLessons.length }})
                </v-btn>
            </v-card-actions>
        </v-card>
    </v-dialog>
...
export default {
    ...
    methods: {
        ...mapMutations(["PRODUCT_LESSON_OPEN", "PRODUCT_FILTER"]),
        ...mapActions(["PRODUCTS", "PRODUCT_RELATED_LESSONS_FILTER_BY_IDS"]),
