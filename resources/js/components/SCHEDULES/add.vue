...
export default {
    ...
    created() {
        ...
        this.SCHEDULE(data);
        this.SCHEDULE_GET_ALL_DETAILS({id: 0});
    },
    ...
    methods: {
        ...
        ...mapActions(["SCHEDULE_GET_ALL_DETAILS", "WEEKDAYS", "SCHEDULE_SAVE"]),
    ...
    computed: {
        ...mapState(["schedule", "location", "studio", "product", "registration", "weekday"]),
