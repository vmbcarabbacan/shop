                    ...
                    <v-card-text id="export">
                        ...
                        <v-simple-table id="product">
                            <template v-slot:default>
                                <thead>
                                    <tr>
                                        <th class="text-center" colspan="7"> <h1>Sales Report</h1> </th>
                                    </tr>
                                    <tr>
                                        <th class="text-center" colspan="7"> <h4> {{ dateRangeText }} </h4> </th>
                                    </tr>
                                    <tr>
...
export default {
    ...
    methods: {
        ...mapActions(["REPORT_FILTER_SALES", "REPORT_SALES_RECEIPTS"]),
        ...mapMutations(["REPORT_SALES", "REPORT_SALE_RECEIPTS"]),
