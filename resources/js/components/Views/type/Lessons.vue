        ...
        >
          <v-expansion-panel>
            <v-expansion-panel-content
              v-for="(category, index) in product.typeLessons.categories"
              :key="index"
            >
              <v-checkbox
                v-model="checkFilter"
            ...
            >
              <template>
                <div class="text-center">
                  <v-pagination
                    v-if="product.typeLessons.items.last_page > 1"
                    v-model="page"
                    :length="product.typeLessons.items.last_page"
                    @input="paginate"
                  ></v-pagination>
                </div>
              </template>
...
export default {
    ...
    methods: {
      ...mapActions(["PRODUCT_BY_TYPE_LESSONS"]),
      ...
      paginate(e) {
        ...
        this.PRODUCT_BY_TYPE_LESSONS({type: 'Lessons', filter:this.checkFilter, page, perPage: 12});
      },
      ...
      addFilter() {
        ...
        this.PRODUCT_BY_TYPE_LESSONS({type: 'Lessons', filter: this.checkFilter, page: 1, perPage: 12});
      }
    },
